...
def setClock(ssh):
    ...
    print "\nCLOCK CONFIGURATION"
    print "SYNTAX: hh mm ss dd MONTH yyyy \n"
    hh = raw_input("hh: ")
    mm = raw_input("mm: ")
    ss = raw_input("ss: ")
    dd = raw_input("date: ")
...
def vlanConf(ssh):
	...
	print "Ready to load VLANs from csv file"
	print "Note: csv file must contain 3 fields named 'vlan_id', 'name', and 'int'"
...
def fileMan(ssh):
    ...
    if menu_choice == 1:
        ...
        print "Ready to load config from file"
